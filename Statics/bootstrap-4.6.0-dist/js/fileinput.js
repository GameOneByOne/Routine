    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tFooter = '<div class="file-thumbnail-footer">\n' +
                ...
                '        <div class="input-group-sm"><input id="bookName" type="text" class="form-control" placeholder="电子书名称"></div>' +
                '        <div class="input-group-sm"><input id="bookAuthor" type="text" class="form-control" placeholder="电子书作者"></div>' +
                '    </div>\n' +
                '    {progress}\n{indicator}\n{actions}\n' +
                '</div>';
